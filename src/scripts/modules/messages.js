...
module.exports = {
    ...
    defaultData: 'You appear to be offline or a service is down. Using default location: ',
    lastKnown: 'You appear to be offline or a service is down. Using last location: ',
